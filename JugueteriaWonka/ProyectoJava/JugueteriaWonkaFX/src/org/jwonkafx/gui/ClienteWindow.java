...
import static org.jwonkafx.gui.EmpleadoWindow.formatDate;
...
public class ClienteWindow  {
    ...
    private void llenarContenedores(Cliente c) throws Exception{
        ...
        String date = formatDate(c.getPersona().getFechaNacimiento(), "dd/mm/yyy", "yyy-mm-dd");
